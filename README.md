...
- **`myclass-filter` ARIA 미완성** — `role="tablist"` · `role="tab"`을 쓰면서
  `aria-controls`로 카드 그리드와 연결돼 있지 않습니다.
  연결을 붙이거나 role을 축소해야 패턴이 완결됩니다.
...
159개 페이지에 헤더가 복제된 구조라, 반응형은 **공통 컴포넌트를 한 번 정의하고
...
1페이지에서 159페이지로 확장하는 동안 초기 요구사항이 유지되는지를 전수 측정했습니다.
...
| 항목 | 07-29 | 07-30 | 07-31 | 08-01 | 08-02 | 08-03 | 08-05 | 08-06 |
|---|---|---|---|---|---|---|---|---|
| HTML | 1 | 80 | 125 | 136 | 152 | 157 | 157 | **159** |
| `style.css` | 1,546 | 2,044 | 4,306 | 6,524 | 8,379 | 9,037 | — | 재측정 예정 |
| JavaScript | 0 | 93 | 93 | 139 | 788 | 970줄 (14파일) | 신규 5종 | 신규 7종 · 재측정 예정 |
| 이미지 | 61 | 2,284 | 2,665 | 2,834 | 3,530 | **3,561** | — | 재측정 예정 |
| 커밋 | 1 | 85 | 117 | 151 | 180 | 196 | 214 | **약 246** |
| 지적 건수 | — | 21 | 24 | 35 | 49 | — | 34 | **누계 196** |

줄 수 · 이미지 총계는 08-03 이후 재측정 전입니다.
08-06 커밋은 작업 리뷰 기준 약 32건이라 누계도 근사값이며, 아래로 확정할 수 있습니다.

```bash
git rev-list --count HEAD
git log --oneline --since="2026-08-06 00:00" --until="2026-08-06 23:59" | wc -l
```
...
페이지당 약 226줄씩 159개 파일에 복제돼 있습니다. GNB 항목 하나를 바꾸려면 전 파일을
