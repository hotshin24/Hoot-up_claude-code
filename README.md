...
| 접근성 요구사항을 PRD로 명문화 | JavaScript 구현 |
...
| 08-01 | 푸터 페이지 16종 · 컬러 토큰화 | 136 | **35건** |
...
| 항목 | 07-30 (80p) | 07-31 (125p) | 08-01 (136p) |
|---|---|---|---|
| 이미지 총계 | 2,284 | 2,665 | **2,834** |
| `alt` 속성 누락 | 0 | 0 | **0** |
| `loading="lazy"` | 96% | 95% | 93% |
| `skip-link` 보유 | 80 / 80 | 125 / 125 | **136 / 136** |
| 페이지당 `h1` | 1개 × 80 | 1개 × 125 | **1개 × 136** |
...
| 항목 | 07-30 | 07-31 | 08-01 |
|---|---|---|---|
| `style.css` | 2,044줄 | 4,306줄 | **6,524줄** |
| 하드코딩 색상값 | 2건 | 21건 | **88건** ⚠️ |
| 지역 테마 토큰 선언 | — | 15건 | 15건 |
| 신설 토큰 | — | — | `--color-brand-dark` |
| `!important` | **0건** | **0건** | **0건** |
...
| 항목 | 07-29 | 07-30 | 07-31 | 08-01 |
|---|---|---|---|---|
| HTML | 1 | 80 | 125 | **136** |
| `style.css` | 1,546줄 | 2,044줄 | 4,306줄 | **6,524줄** |
| 이미지 | 61 | 2,284 | 2,665 | **2,834** |
| 커밋 | 1 | 85 | 117 | **151** |
...
접근성 지표는 1페이지에서 136페이지까지 무너지지 않았습니다.
반면 하드코딩 색상은 2건 → 21건 → 88건으로 늘었습니다.
